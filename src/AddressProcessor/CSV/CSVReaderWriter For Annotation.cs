...
namespace AddressProcessing.CSV
{
	/*
		...
		*) Reader and Writer may not be initialised or end up not closed
		*) No argument null checks
		*) One rad method changing parameter values that are local only
		*) Slow and inefficient string concatenation going on
		*) No need for flags instead of a normal enum as only one more is allowed at a time
	*/
